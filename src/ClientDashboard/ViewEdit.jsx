        ...
        <div className='fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn'>
            ...
            <div className='bg-gradient-to-b from-blue-300 to-pink-200 rounded-2xl shadow-2xl max-w-md w-full p-6 transform animate-slideUp'>
                <div className=' flex justify-between items-center mb-4'>
                    <h3 className='w-full h-8 bg-gradient-to-b from-blue-400 to-pink-200 text-xl font-bold text-gray-800 rounded-sm'>{selectedProject.title}</h3>
            ...
            {editingProject && (
                <div className='fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn'>
                    <div className='bg-gradient-to-b from-blue-300 to-pink-200 rounded-2xl shadow-2xl max-w-md w-full p-6 transform animate-slideUp'>
                        <div className='w-full h-8 bg-gradient-to-b from-blue-400 to-pink-200 flex justify-between items-center mb-4 rounded-sm'>
